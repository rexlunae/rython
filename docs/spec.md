...
| `return NotImplemented` names the singleton only when no parameter or local of the function shadows the name; a shadowing binding is an ordinary value | Correct (Devin review on #330) |
