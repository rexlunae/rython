...
pub(crate) static BUILTIN_EXCEPTION_MRO: &[(&str, &[&str])] = &[
    ...
    ("UnsupportedOperation", &["UnsupportedOperation", "OSError", "ValueError", "Exception", "BaseException"]),
...
impl BuiltinException {
    ...
    pub fn from_name(name: &str) -> Option<Self> {
        match name {
            ...
            "UnsupportedOperation" => Some(Self::UnsupportedOperation),
    ...
    pub fn ancestors(self) -> &'static [Self] {
        match self {
            ...
            Self::UnsupportedOperation => &[Self::OSError, Self::ValueError, Self::Exception, Self::BaseException],
